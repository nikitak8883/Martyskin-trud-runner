...
Статус: `M04_C_ACHIEVEMENT_UI_CHILD_COMPLETE / M04_C_FAMILIES_READY / RELEASE_BLOCKED`  
...
- Исполнение от текущей точки: `66` обязательных v4 execution units, включая inventory-derived `M04-C-FAMILY-ACHIEVEMENT-UI`; `14/66` завершены, `52` остаётся. Ещё `7` units условные. Знаменатель provisional до дальнейшей инвентаризации child batches M04/M05/M10.
...
1. Продолжить `M04-C-FAMILIES`: после принятых `objective_npc` и `achievement_ui` выбрать ровно один следующий measured static-atlas family до мутации.
