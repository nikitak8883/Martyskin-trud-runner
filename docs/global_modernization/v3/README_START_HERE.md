...
- M04-C-FAMILY-THEME-CONSTRUCTION: принят восьмой isolated family из 24 construction hazard/platform PNG через один recursive parent descriptor. Comparison `63/63`; Web draws `41 → 31`, Android `54 → 31` (`-42.5926%`), source textures `24 → 1`, exact-repeat/zero-material-new-white, Web `34/34 × 2`, silent Android-emulator `28/28 × 2` и interaction/restart/soak проходят. Aggregate `M04.5` по-прежнему pending.
