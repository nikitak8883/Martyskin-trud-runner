...
Выполнить `M03.4`: направить jump, glide, dash и pause через один input adapter, сохранив порядок side effects, debounce и единственное владение listener-ами. Release остаётся blocked.
