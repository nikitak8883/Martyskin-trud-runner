...
Следовать `../TOOL_AND_CODE_ADAPTATION_BACKLOG.md` и `../WORK_PACKAGE_INDEX.yaml`. M01.5 evidence retention принят; следующий bounded package — M01.6 после решения о primary source remote. Draft/runtime seams по-прежнему не активируются без своих dependency gates, adapters и parity tests.
