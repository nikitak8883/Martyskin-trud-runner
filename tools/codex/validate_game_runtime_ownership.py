...
def main() -> int:
    ...
    require(game_root.count("scheduleComponentOnce(") == 16, "component_schedule_route_count", errors)
    require(game_root.count("qa.atlas-pilot-") == 4, "atlas_pilot_schedule_route_count", errors)
