...
if (-not (Test-Path -LiteralPath $androidActivityPath)) {
    ...
    foreach ($key in @('mtr_qa_obstacles', 'mtr_spawn_obstacles', 'mtr_qa_bonuses', 'mtr_spawn_bonuses', 'mtr_qa_reset_loops', 'mtr_qa_collisions', 'mtr_qa_powerups', 'mtr_qa_ownership')) {
