/**
 * Pure monotonic lifecycle identity shared by diagnostics and runtime owners.
 * Scheduling and stale-callback suppression belong to GameRuntimeLifecycleOwner;
 * this primitive only publishes and validates the current epoch.
 */
